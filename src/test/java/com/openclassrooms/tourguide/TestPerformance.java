		...
		public void highVolumeTrackLocation(int numberOfUsers) {
			...
			System.out.println(
					"highVolumeTrackLocation: Time Elapsed: " +
							TimeUnit.NANOSECONDS.toSeconds(stopWatch.getNanoTime()) +
							" seconds.");
			assertTrue(
					TimeUnit.MINUTES.toSeconds(15) >= TimeUnit.NANOSECONDS.toSeconds(stopWatch.getNanoTime()));
		}
	}
		...
		public void highVolumeGetRewards(int numberOfUsers) {
			...
			System.out.println(
					"highVolumeGetRewards: Time Elapsed: " +
							...
							" seconds.");
			assertTrue(
					TimeUnit.MINUTES.toSeconds(20) >= TimeUnit.NANOSECONDS.toSeconds(stopWatch.getNanoTime()));
		}
	}
}
